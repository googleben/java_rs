...
#[repr(C)]
#[derive(Copy, Clone)]pub union jvalue { pub z : jboolean , pub b : jbyte , pub c : jchar , pub s : jshort , pub i : jint , pub j : jlong , pub f : jfloat , pub d : jdouble , pub l : jobject , _bindgen_union_align : u64 , }#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub struct JNIInvokeInterface_ {
    ...
    pub AttachCurrentThread:
        ::std::option::Option<
            unsafe extern "C" fn(vm: *mut JavaVM,
